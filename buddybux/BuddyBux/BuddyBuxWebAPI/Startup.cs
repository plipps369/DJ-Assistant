...
namespace BuddyBuxWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "BuddyBux API", Version = "v1" });
            });
            ...
            services.AddTransient<IBuddyBuxDAO>(m => new BuddyBuxDAO(connectionString));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "BuddyBux API v1");
            });
